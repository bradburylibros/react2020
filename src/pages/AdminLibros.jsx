...
import AdminLibrosLista from '../componentes/AdminLibrosLista';
import LibroFila from '../componentes/LibroFila';
import LibroTapa from '../componentes/LibroTapa';
...
export default function AdminLibros() {
	...
	const newLibros = data.datos;

	// const newLibros = data.datos.filter((libro) => {
	// 	return libro.titulo
	// 		.toLowerCase()
	// 		.includes(buscarLibro.nombre.toLowerCase());
	// });
			...
			<Row ClassName="justify-content-between">
				...
				{data.loading ?
					...
					<ul>
						{newLibros.map((libro) => {
							return (
								<LibroFila libro={libro} />
							);
						})}
					</ul>

					// (<AdminLibrosLista libros={newLibros} />)
				}
